...
/**
*
* Nome: Luana Vitória Gomes de Souza  
* Curso: IPI
* Matrícula: 20221INFIG0240
* 
*/
public class ContaBancaria {
	...
	public void sacar(double valor) {
		...
		this.saldo -= valor;
		System.out.print("Saque realizado com sucesso. Novo saldo: " + this.saldo);
	}
	...
	public void reabrirConta() {
		...
		this.status = true;
		System.out.print("Conta ativada com sucesso.");
	}
